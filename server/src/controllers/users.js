...
var UsersController = function () {
    var _classDecorators = [(0, controller_1.Controller)('/api/gachatracker/gachatrackerusers')];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.loginUser = function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, email, password, user, isPasswordValid, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, usersModel_1.Users.findOne({ email: email })];
                        case 1:
                            user = _b.sent();
                            if (!user) {
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, res.status(200).json({ message: 'User logged in' })];
                        case 3:
                            error_1 = _b.sent();
        ...
        UsersController_1.prototype.getAllUsers = function (req, res) {
            console.log('Get all users');
            return res.status(200).json(req.mongoGetAll);
        };
        // @MongoGet(Users)
        UsersController_1.prototype.getUserById = function (req, res) {
            return res.status(200).json(req.mongoGet);
        };
        UsersController_1.prototype.createUser = function (req, res) {
            return res.status(200).json(req.mongoCreate);
        };
        // @MongoUpdate(Users)
        UsersController_1.prototype.updateUser = function (req, res) {
            return res.status(200).json(req.mongoUpdate);
        };
        // @MongoDelete(Users)
        UsersController_1.prototype.deleteUser = function (req, res) {
    ...
    (function () {
        ...
        _loginUser_decorators = [(0, route_1.Route)('post', '/login')];
        ...
        _createUser_decorators = [(0, route_1.Route)('post', '/create'), (0, create_1.MongoCreate)(usersModel_1.Users)];
