...
var MainController = function () {
    var _classDecorators = [(0, controller_1.Controller)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _get_decorators;
    var MainController = _classThis = /** @class */ (function () {
        function MainController_1() {
            __runInitializers(this, _instanceExtraInitializers);
        }
        MainController_1.prototype.get = function (req, res, next) {
            console.log('Hello World!');
            return res.status(200).json({ message: 'Hello World!' });
        };
        return MainController_1;
    }());
    __setFunctionName(_classThis, "MainController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _get_decorators = [(0, route_1.Route)('get', '/')];
