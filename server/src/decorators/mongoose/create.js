                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            data = new model(__assign(__assign({ _id: new mongoose_1.default.Types.ObjectId() }, req.body), { image: req.file ? req.file.buffer : undefined }));
                        ...
                        case 5: return [2 /*return*/, originalMethod.call(this, req, res, next)];
                    }
                });
            });
        };
