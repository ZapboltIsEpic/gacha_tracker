...
var declareHandler_1 = require("./middleware/declareHandler");
...
var fgo_servants_1 = require("./controllers/fgo-servants");
...
var Shutdown = function (callback) {
    mongoose_1.default.connection.close(false).then(function () {
...
(0, exports.Main)().catch(function (err) { return console.error('Error starting server:', err); });
